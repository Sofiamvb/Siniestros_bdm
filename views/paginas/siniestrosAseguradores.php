            ...
            <div class="card-row-with-actions">
                <div class="card-left-col">
                    <div class="mini-carousel">
                        ...
                        <div class="mini-carousel-view">
                            <img src="/img/siniestro.jpg" alt="Siniestro" class="mini-carousel-image" data-accident-img="/img/siniestro.jpg">
                        </div>
                ...
                <div class="card-right-col">
                    ...
                    <div class="status-row">
                        <h2 class="status-title">Estado: <span class="text-black">En revisión</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="card-row-with-actions">
                <div class="card-left-col">
                    <div class="mini-carousel">
                        <button type="button" class="mini-carousel-btn" disabled aria-label="Anterior">‹</button>
                        <div class="mini-carousel-view">
                            <img src="/img/siniestro1.jpg" alt="Siniestro" class="mini-carousel-image" data-accident-img="/img/siniestro1.jpg">
                        </div>
                        <button type="button" class="mini-carousel-btn" disabled aria-label="Siguiente">›</button>
                    </div>
                    <p class="adjuster-text">Ajustador: Juan Ángel Oropeza</p>
                ...
                <div class="card-right-col">
                    ...
                    <div class="status-row">
                        <h2 class="status-title">Estado: <span class="text-black">Aceptado.</span></h2>
                    </div>
                </div>
            </div>
            <button class="icon-btn-supervisor-top" onclick="openSupervisorModal()"><img src="/img/adjuntar.png" alt="Supervisor" class="icon-btn-image-dim"></button>
        ...
        <div class="details-modal-panel">
            ...
            <div class="details-body">
                <div class="details-section details-section-active" id="aseguradora-section">
                    ...
                    <div class="details-field"><label class="field-label-sm">Tiempo de seguro</label><input type="text" class="input-field-soft" placeholder="Tiempo de seguro" readonly></div>
                ...
                <div class="details-section details-section-hidden" id="auto-section">
                    ...
                    <div class="details-field"><label class="field-label-sm">Nombre del conductor</label><input type="text" class="input-field-soft" placeholder="Nombre del conductor" readonly></div>
                    ...
                    <div class="details-field"><label class="field-label-sm">Placas</label><input type="text" class="input-field-soft" placeholder="Número de placas" readonly></div>
                </div>
